...
const ExercisePicker = ({ addExercise }) => {
  ...
  const exercises = [
    ...
    { name: "Running", type: "cardio", required: [{name: "time", unit: "hh:mm:ss"}, {name: "distance", unit: "mi"}], optional: [{name: "avhr", unit: "bpm"}, {name: "pace", unit:"min/mile"}]},
    { name: "Cycling", type: "cardio", required: [{name: "time", unit: "hh:mm:ss"}, {name: "distance", unit: "mi"}], optional: [{name: "avhr", unit: "bpm"}, {name: "speed", unit:"mph"}]},
    { name: "Running (stationary)", type: "cardio", required: [{name: "time", unit: "hh:mm:ss"}], optional: [{name: "distance", unit: "mi"}, {name: "avhr", unit: "bpm"}, {name: "pace", unit:"min/mile"}]},
    { name: "Cycling (stationary)", type: "cardio", required: [{name: "time", unit: "hh:mm:ss"}], optional: [{name: "distance", unit: "mi"}, {name: "avhr", unit: "bpm"}, {name: "speed", unit:"mph"}]},
